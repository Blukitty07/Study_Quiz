...
class StartGame:
    ...
    def __init__(self):
        ...
        self.mode_button_frame = Frame(self.start_frame, pady=25, padx=10)
...
class Play:
    ...
    def new_round(self, mode):
        ...
        for count, item in enumerate(self.answer_button_ref):
            item.config(text=questions[count], bg=background_ref_list[count], wraplength=140, state=NORMAL)
    ...
    def get_score(self, user_choice):
        ...
        # change buttons colours
        # correct button colour
        # incorrect button colour
        ...
        number = int(self.round_number_ref)
...
# will need to make current leaderboard file into test file and make new empty one for the actual leaderboard
class Leaderboard:
    """
    Interface for playing the study quiz
    """
